...
#ifndef CROWN_TEST_SCRIPTNUM10_H
#define CROWN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Crown Core 0.10.0, for cross-comparison.
 */
public:

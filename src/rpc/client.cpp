...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "createasset", 5, "input amount"},
    { "createasset", 6, "asset amount"},
    { "createasset", 7, "expiry"},
    { "createasset", 8, "type"},
    { "createasset", 9, "transferable"},
    { "createasset", 10, "convertable"},
    { "createasset", 11, "restricted"},
    { "createasset", 12, "limited"},
    { "createasset", 13, "divisible"},

...
#ifndef CROWN_CRYPTO_CHACHA_POLY_AEAD_H
#define CROWN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@crown.
 *
 ...
 *
 * The chacha20-poly1305@crown combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@crown cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@crown are relatively fast in
...
#endif // CROWN_CRYPTO_CHACHA_POLY_AEAD_H

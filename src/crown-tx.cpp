...
static void SetupCrownTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " crown-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  crown-tx [options] <hex-tx> [commands]  Update hex-encoded crown transaction\n" +
            "or:     crown-tx [options] -create [commands]   Create hex-encoded crown transaction\n" +
            "\n";

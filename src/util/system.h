 ...
 */
#ifndef CROWN_UTIL_SYSTEM_H
#define CROWN_UTIL_SYSTEM_H
...
extern const char * const CROWN_CONF_FILENAME;
extern const char * const CROWN_SETTINGS_FILENAME;

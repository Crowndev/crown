...
#ifndef CROWN_WALLET_WALLETUTIL_H
#define CROWN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! crown from opening the wallet, thinking it was newly created, and
...
#endif // CROWN_WALLET_WALLETUTIL_H

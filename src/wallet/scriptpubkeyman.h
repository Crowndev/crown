...
#ifndef CROWN_WALLET_SCRIPTPUBKEYMAN_H
#define CROWN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Crown Core wallet was originally a collection of unrelated private
...
#endif // CROWN_WALLET_SCRIPTPUBKEYMAN_H

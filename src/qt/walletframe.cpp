...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, CrownGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &CrownGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &CrownGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &CrownGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &CrownGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &CrownGUI::updateWalletStatus);
    connect(gui, &CrownGUI::setPrivacy, walletView, &WalletView::setPrivacy);

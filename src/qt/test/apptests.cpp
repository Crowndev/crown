...
//! Entry point for CrownApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CrownApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CrownGUI tests.
void AppTests::guiTests(CrownGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CrownGUI::consoleShown, this, &AppTests::consoleTests);

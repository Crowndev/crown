...
*/
class CrownUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CrownUnits(QObject *parent);

    /** Crown units.
      @note Source: https://en.crown.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,

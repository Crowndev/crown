...
#ifndef CROWN_QT_WALLETFRAME_H
#define CROWN_QT_WALLETFRAME_H
 ...
 * controls into CrownGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to CrownGUI, thus greatly simplifying merges while
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, CrownGUI *_gui = nullptr);
    ~WalletFrame();

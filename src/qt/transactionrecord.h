...
#ifndef CROWN_QT_TRANSACTIONRECORD_H
...
public:
    ...
    TransactionRecord():
            hash(), time(0), type(Other), address(""), amount(0), asset(CAsset()), idx(0)
    {
    }

    TransactionRecord(uint256 _hash, qint64 _time):
            hash(_hash), time(_time), type(Other), address(""), amount(0), asset(CAsset()),
            idx(0)
    {
    }
...
#endif // CROWN_QT_TRANSACTIONRECORD_H

...
#ifndef CROWN_QT_CROWNGUI_H
#define CROWN_QT_CROWNGUI_H
...
/**
  Crown GUI main class. This class represents the main window of the Crown UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CrownGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CrownGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~CrownGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a crown wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */

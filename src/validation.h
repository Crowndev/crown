...
#ifndef CROWN_VALIDATION_H
#define CROWN_VALIDATION_H
...
bool AcceptToMemoryPool(CTxMemPool& pool, TxValidationState &state, const CTransactionRef &tx,
                        ...
                        bool bypass_limits, bool test_accept=false, CAmountMap* fee_out=nullptr) EXCLUSIVE_LOCKS_REQUIRED(cs_main);

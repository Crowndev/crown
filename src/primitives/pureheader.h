...
// Copyright (c) 2009-2013 The Crown developers
// Copyright (c) 2009-2021 Block Mechanic
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CROWN_PRIMITIVES_PUREHEADER_H
#define CROWN_PRIMITIVES_PUREHEADER_H
...
#endif // CROWN_PRIMITIVES_PUREHEADER_H

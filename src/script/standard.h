...
#ifndef CROWN_SCRIPT_STANDARD_H
#define CROWN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a crown address
 */
...
/**
 * Generate a Crown scriptPubKey for the given CTxDestination. Returns a P2PKH

...
#ifndef CROWN_SCRIPT_INTERPRETER_H
#define CROWN_SCRIPT_INTERPRETER_H
...
struct PrecomputedTransactionData
{
    ...
    // These are single-SHA256, see https://github.com/crown/bips/blob/master/bip-0341.mediawiki#cite_note-15.
    uint256 m_prevouts_single_hash;
    uint256 m_sequences_single_hash;
    uint256 m_outputs_single_hash;
    uint256 m_spent_amounts_single_hash;
    uint256 m_spent_scripts_single_hash;
    uint256 m_vdata_single_hash;
    uint256 m_data_single_hash;
    //! Whether the 5 fields above are initialized.
    bool m_bip341_taproot_ready = false;

    // BIP143 precomputed data (double-SHA256).
    uint256 hashPrevouts, hashSequence, hashOutputs, hashData, hashVData;
...
#endif // CROWN_SCRIPT_INTERPRETER_H

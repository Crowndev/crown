...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the crown repository."
  exit 1
fi
...
# See https://github.com/crown/crown/issues/16064
...
echo 'When compiling crownd, run `./configure` in the following way:'
echo

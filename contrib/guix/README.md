# Bootstrappable Crown Core Builds

This directory contains the files necessary to perform bootstrappable Crown
Core builds.
...
- 24GB of free disk space on the partition that the Crown Core git repository
  resides in
...
From the top of a clean Crown Core repository:
...
To use dongcarl's substitute server for Crown Core builds after having

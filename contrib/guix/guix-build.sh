...
# Deterministically build Crown Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/crown'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/crown/' to
        #     '/home/satoshi/crown/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/crown
        #
        #                     maps our current working directory to /crown
        ...
        #     container so that we have something to build. '/crown' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /crown && bash contrib/guix/libexec/build.sh"
    )

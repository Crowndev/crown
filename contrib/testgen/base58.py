...
'''
Crown base58 encoding and decoding.

Based on https://crowntalk.org/index.php?topic=1026.0 (public domain)
'''
import hashlib
...
def b58encode(v):
    ...
    # Crown does a little leading-zero-compression:
...
if __name__ == '__main__':
    # Test case (from http://gitorious.org/crown/python-base58.git)

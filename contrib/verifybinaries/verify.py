...
crowncore.org and crown.org and compares them.
...
WORKINGDIR = "/tmp/crown_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://crowncore.org"
HOST2 = "https://crown.org"
VERSIONPREFIX = "crown-core-"
...
def main(args):
    ...
    if not success:
        print("crown.org failed to provide signature file, "
              "but crowncore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("crown.org and crowncore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Crown Core binary release "

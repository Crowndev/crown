...
This document provides guidelines for internationalization of the Crown Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `crown_en.ts` remains unchanged.

Crown Core version 0.16.0 is now available from:
...
Crown Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Crown Core is now 4.8. No effort will be

Crown v0.3.24 is now available for download at
https://sourceforge.net/projects/bitcoin/files/Crown/bitcoin-0.3.24/
...
C3) Initial unit testing framework.  Crown sorely needs automated tests, and this is a beginning.  Contributions welcome.

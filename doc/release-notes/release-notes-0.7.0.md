Crown version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bitcoin/files/Crown/bitcoin-0.7.0/

We recommend that everybody running prior versions of bitcoind/Crown-Qt
...
Crown Improvement Proposals implemented

Crown version 0.5.0 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Crown/bitcoin-0.5.0/
...
If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or bitcoind the wallet will be rewritten, Crown will
...
Crown-Qt: Address Book, then New Address...

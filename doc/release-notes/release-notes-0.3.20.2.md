...
The Amazon Machine Images I used to do the builds are available:
  ...
  ami-38a05251   Crown-v0.3.20.2 Mingw    (Windows; Administrator password 'bitcoin development')
  ami-30a05259   Crown_0.3.20.2 Linux32
  ami-8abc4ee3   Crown_0.3.20.2 Linux64

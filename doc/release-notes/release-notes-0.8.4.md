Crown-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Crown/bitcoin-0.8.4/
...
code, causing the Crown-Qt or bitcoind process to crash.
...
their own version of Crown against Boost versions 1.50-1.52.

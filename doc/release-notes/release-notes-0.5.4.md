Crown version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Crown/bitcoin-0.5.4/
...
Fix Crown-Qt notifications under Growl 1.3.
Increase required age of Crown-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCrown properly when installing Crown-Qt over it. (Windows)

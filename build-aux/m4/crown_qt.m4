dnl Copyright (c) 2013-2016 The Crown Core developers
...
dnl CROWN_QT_PATH_PROGS([FOO], [foo foo2], [/path/to/search/first], [continue if missing])
...
dnl This must be called before any other CROWN_QT* macros to ensure that
dnl input variables are set correctly.
dnl CAUTION: Do not use this inside of a conditional.
AC_DEFUN([CROWN_QT_INIT],[
...
dnl
dnl   CROWN_QT_CONFIGURE([MINIMUM-VERSION])
dnl
dnl Outputs: See _CROWN_QT_FIND_LIBS
dnl Outputs: Sets variables for all qt-related tools.
dnl Outputs: crown_enable_qt, crown_enable_qt_dbus, crown_enable_qt_test
AC_DEFUN([CROWN_QT_CONFIGURE],[
  qt_version=">= $1"
  qt_lib_prefix="Qt5"
  ...
  CROWN_QT_PATH_PROGS([MOC], [moc-qt5 moc5 moc], $qt_bin_path)
  CROWN_QT_PATH_PROGS([UIC], [uic-qt5 uic5 uic], $qt_bin_path)
...
AC_DEFUN([_CROWN_QT_IS_STATIC],[
  AC_CACHE_CHECK(for static Qt, crown_cv_static_qt,[
    AC_COMPILE_IFELSE([AC_LANG_PROGRAM([[
        #include <QtCore/qconfig.h>
        #ifndef QT_VERSION
        #  include <QtCore/qglobal.h>

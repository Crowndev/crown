...
class FullBlockTest(CrownTestFramework):
    ...
    def run_test(self):
        ...
        # crownd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the crown code has custom code which does so);

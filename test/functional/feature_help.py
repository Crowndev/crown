#!/usr/bin/env python3
# Copyright (c) 2018-2019 The Crown Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting crown with -h works as expected."""

from test_framework.test_framework import CrownTestFramework
from test_framework.util import assert_equal

class HelpTest(CrownTestFramework):
    ...
    def run_test(self):
        self.log.info("Start crown with -h for help text")
        ...
        self.log.info("Start crown with -version for version information")
        ...
        self.log.info("Start crownd with -fakearg to make sure it does not start")

...
class P2PPermissionsTests(CrownTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].crownconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].crownconf, 'w', encoding="utf8") as f:
            f.write(newText)

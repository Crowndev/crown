...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CrownTestFramework
    pass


class ExampleTest(CrownTestFramework):
    # Each functional test is a subclass of the CrownTestFramework class.
    ...
    def custom_method(self):
        ...
        CrownTestFramework class so other tests can use it."""

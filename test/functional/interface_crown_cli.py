...
class TestCrownCli(CrownTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `crown-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and crown-cli getwalletinfo return expected wallet info")
            ...
            # Test crown-cli -generate with -rpcwallet in multiwallet mode.

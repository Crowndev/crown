...
class TestShell:
    """Wrapper Class for CrownTestFramework.

    The TestShell class extends the CrownTestFramework
    ...
    class __TestShell(CrownTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CrownTestFramework child class.
            self.num_nodes = 1

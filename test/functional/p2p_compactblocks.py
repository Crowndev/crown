#!/usr/bin/env python3
# Copyright (c) 2016-2019 The Crown Core developers
...
# TestP2PConn: A peer we use to send messages to crownd, and store responses.
...
class CompactBlocksTest(CrownTestFramework):
    ...
    # This test actually causes crownd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that crownd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for crownd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # crownd will not send blocktxn responses for blocks whose height is

...
By default, crownd will dump mempool on shutdown and
...
class MempoolPersistTest(CrownTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent crownd from writing mempool.dat to disk. Verify that `savemempool` fails")

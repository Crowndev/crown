...
// crown includes.
#include <..\src\script\crownconsensus.h>
...
int main()
{
    std::cout << "crownconsensus version: " << crownconsensus_version() << std::endl;
    ...
    auto op0Result = crownconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, crownconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
